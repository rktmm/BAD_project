...
cd /mnt/data-disk/tmp_scratch/output/trimmed-data

mkdir -p /mnt/data-disk/tmp_scratch/output/humann4_output
...
for Reads in *.fastq.gz
  do
    humann --input ${Reads} \
      --output /mnt/data-disk/tmp_scratch/output/humann4_output \
